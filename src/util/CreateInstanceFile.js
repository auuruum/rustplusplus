...
module.exports = (client, guild) => {
    ...
    if (!Fs.existsSync(Path.join(__dirname, '..', '..', 'instances', `${guild.id}.json`))) {
        ...
        if (!instance.wakeSettings.hasOwnProperty('repeatSeconds')) instance.wakeSettings.repeatSeconds = 90;
        if (instance.wakeSettings.repeatSeconds < 90) instance.wakeSettings.repeatSeconds = 90;
