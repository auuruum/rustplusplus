...
> Documentation can be found [here](https://github.com/auuruum/rustplusplus/blob/master/docs/documentation.md). Optional Rust Wake note: [docs/rust-wake.md](docs/rust-wake.md).
