...
module.exports = {
    ...
    license: {
        ...
        password: process.env.RPP_LICENSE_PASSWORD || '',
        webhookUrl: process.env.RPP_LICENSE_WEBHOOK_URL || '',
        alertRoleId: process.env.RPP_LICENSE_ALERT_ROLE_ID || '',
    },
    payhip: {
        secretKey30d: process.env.RPP_PAYHIP_SECRET_30D || '',
        apiBaseUrl: process.env.RPP_PAYHIP_API_URL || 'https://payhip.com/api/v2',
    }
};
